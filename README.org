...
#+LINK: juts https://github.com/casey/just
...
#+LINK: sketchy-bar https://github.com/FelixKratz/SketchyBar
...
#+LINK: sxhkd https://github.com/baskerville/sxhkd
...
This is a set of Nix-based configuration files for NixOS and macOS.
...
I'm intested in transparent terminals thesedays:
...
| Item         | What I use                            |
|--------------+---------------------------------------|
| Terminals    | [[alacritty]] or [[kitty][kitty]] with [[tmux][tmux]]          |
| Fonts        | Intel One Mono ([[nerd][nerd font]])            |
| Editors      | [[evil][Evil]] Emacs                            |
| Shells       | bash and [[fish][fish]]                         |
| Browsers     | [[qb][qutebrowser]], firefox and [[w3m][w3m]]          |
| Task runners | [[just][just]]                                  |
| Git          | [[ghq][ghq]], [[gh][gh]], [[delta][delta]]                        |
| Grep         | [[rg][rg]], [[hgrep][hgrep]]                             |
| File         | [[fd][fd]], [[as-tree][as-tree]], [[bat][bat]], [[eza][eza]], [[https://github.com/ranger/ranger][ranger]]         |
| macOS        | [[yabai][yabai]], [[skhd][skhd]], [[sketchy-bar][SketchyBar]] and [[karabiner][karabiner]] |
| Linux        | X11, [[i3][i3]], [[sxhkd]], [[flameshot][flameshot]]             |
