...
;; NOTE; alt + backspace is enough for macOS. Same for other OSes? If not, let's set it up.
;; (defun my-minibuffer-up-directory ()
;;   "Go up one directory in the minibuffer prompt."
;;   (interactive)
;;   (let ((current-input (minibuffer-contents)))
;;     (delete-region (minibuffer-prompt-end) (point-max))
;;     (insert (expand-file-name ".." (file-name-directory current-input)))))
;; (define-key minibuffer-local-map (kbd "C-l") 'my-minibuffer-up-directory)
