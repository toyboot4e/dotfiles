...
(leaf consult
  ...
  (progn ;; FIXME: This is from wiki, but is it working?
    (define-key minibuffer-local-map "C-l" #'my-embark-preview)
  ...
  (progn ;; `find-file' -> `consult-ripgrep'
    (defun my/consult-ripgrep-from-find-file ()
      (interactive)
      (if (minibufferp)
          (let ((cwd (file-name-directory (minibuffer-contents))))
            (consult-ripgrep cwd ". "))
    ...
    (keymap-set minibuffer-mode-map
                "C-c g"
                #'my/consult-ripgrep-from-find-file))
  ...
  ;; (keymap-set consult-narrow-map (vconcat consult-narrow-key "?") #'consult-narrow-help)
...
(leaf embark
  ...
  (;; (embark-prompter . #'embark-completing-read-prompter)
   (embark-indicators .
                      (embark-verbose-indicator  ; default is embark-mixed-indicator
...
(evil-define-key 'normal 'toy/global-mode-map
  ...
  ;; in all buffer
  ;; " gB" #'
  " gr" (lambda () (interactive) (consult-ripgrep "." " . "))
  " gR" #'toy/proj-grep)
