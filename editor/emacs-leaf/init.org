...
(add-hook 'f90-mode-hook
          (lambda ()
              ...
              (setopt flycheck-gfortran-language-starndard "f2018")
              (lsp-mode)
              (flycheck-mode)))
#+END_SRC
...
#+BEGIN_SRC elisp
(advice-add 'evil-ex-search-next :after (lambda (&rest _) (toy/smart-center)))
(advice-add 'evil-ex-search-previous :after (lambda (&rest _) (toy/smart-center)))
